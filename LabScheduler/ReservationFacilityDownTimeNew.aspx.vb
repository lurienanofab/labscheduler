...
Namespace Pages
    Public Class ReservationFacilityDownTimeNew
        ...
        Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
            If Not IsPostBack Then
                If Not String.IsNullOrEmpty(Request.QueryString("Date")) Then
                    divFDT.Attributes("data-client-id") = CurrentUser.ClientID.ToString()
                    divFDT.Attributes("data-date") = Request.QueryString("Date")
                End If
                GridDataBind()
                ClearForm()
            End If
        ...
        Protected Sub BtnReserve_Click(sender As Object, e As EventArgs)
            ...
            Dim indices As Integer() = New Integer() {} 'lboxTools.GetSelectedIndices()
