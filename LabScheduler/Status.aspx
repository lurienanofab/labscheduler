...
<script runat="server">
    ...
    async Task LoadToolStatus()
    {
        ...
        {
            DataTable dt = dba.SetCommandType(CommandType.Text).FillDataTable("SELECT ResourceID, ResourceName FROM sselScheduler.dbo.Resource WHERE IsActive = 1 ORDER BY ResourceName");
