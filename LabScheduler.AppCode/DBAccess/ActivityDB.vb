...
Namespace DBAccess
    Public Class ActivityDB
        ...
        Public Function SelectAll() As DataTable
            Return SessionDataCommand.Create().MapSchema().Param("Action", "SelectAll").FillDataTable("sselScheduler.dbo.procActivitySelect")
        End Function
        ...
        Public Shared Function SelectAuthorizedActivities(ByVal UserAuth As Integer) As DataTable
            Dim dt As DataTable = SessionDataCommand.Create() _
        ...
        Public Sub Update(ByRef dt As DataTable)
            SessionDataCommand.Create().Update(dt, Sub(x)
